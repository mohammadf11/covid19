...
/////////////////////////////////////////	
if(strcmp(vorood,"1")==0||strcmp(vorood,"Login to the program")==0){vorood1();}

if(strcmp(vorood,"Create a new account")==0||strcmp(vorood,"2")==0){vorood2();}

if(strcmp(vorood,"3")==0||strcmp(vorood,"forget password")==0){ forget_password(); }
}
////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////
...
if(strcmp(voroodi,"normal user")==0||strcmp(voroodi,"2")==0){ acount_normal_user();}
if(strcmp(voroodi,"Business owners")==0||strcmp(voroodi,"1")==0){acount_sahebin();}
...
if(strcmp(vorood_normal_user,"Health status registration")==0||strcmp(vorood_normal_user,"1")==0){ Health_status_registration(n); }
if(strcmp(vorood_normal_user,"Editing information")==0||strcmp(vorood_normal_user,"2")==0){ Editing_information(n);  }
if(strcmp(vorood_normal_user,"View health history entry history")==0||strcmp(vorood_normal_user,"3")==0){View_health_history_entry_history(n); }
if(strcmp(vorood_normal_user,"Record appointments with other people")==0||strcmp(vorood_normal_user,"4")==0){Record_appointments_with_other_people(n);  }
if(strcmp(vorood_normal_user,"Meeting history")==0||strcmp(vorood_normal_user,"5")==0){	Meeting_history(n);}
if(strcmp(vorood_normal_user,"Add places that are gone")==0||strcmp(vorood_normal_user,"6")==0){Add_places_that_are_gone(n); }
if(strcmp(vorood_normal_user,"View the history of places you have visited")==0||strcmp(vorood_normal_user,"7")==0){View_the_history_of_places_you_have_visited(n); }
if(strcmp(vorood_normal_user,"View Corona statistics")==0||strcmp(vorood_normal_user,"8")==0){View_Corona_statistics(n); }
if(strcmp(vorood_normal_user,"Visit nearby hospitals and medical centers")==0||strcmp(vorood_normal_user,"9")==0){ Visit_nearby_hospitals_and_medical_centers(n);}		
if(strcmp(vorood_normal_user,"sign out")==0||strcmp(vorood_normal_user,"10")==0){ voroodkarbar();}
...
if(strcmp(voroodi_View_Corona,"Daily statistics")==0||strcmp(voroodi_View_Corona,"1")==0){ Daily_statistics(n);}
if(strcmp(voroodi_View_Corona,"Weekly statistics")==0||strcmp(voroodi_View_Corona,"2")==0){Weekly_statistics(n);}	
}
//////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////
...
if(strcmp(vorood_edit_karbar_adi,"edit  Firstname")==0||strcmp(vorood_edit_karbar_adi,"1")==0){edit_firstname_karbaradi(n); }
if(strcmp(vorood_edit_karbar_adi,"edit  lastname")==0||strcmp(vorood_edit_karbar_adi,"2")==0){ edit_lastname_karbaradi(n); }
if(strcmp(vorood_edit_karbar_adi,"edit  NationalCode")==0||strcmp(vorood_edit_karbar_adi,"3")==0){edit_NationalCode_karbaradi(n) ;}
if(strcmp(vorood_edit_karbar_adi,"edit  username")==0||strcmp(vorood_edit_karbar_adi,"4")==0){ edit_username_karbaradi(n); }
if(strcmp(vorood_edit_karbar_adi,"edit  email")==0||strcmp(vorood_edit_karbar_adi,"5")==0){edit_email_karbaradi(n) ;};
if(strcmp(vorood_edit_karbar_adi,"edit  Weight")==0||strcmp(vorood_edit_karbar_adi,"6")==0){ edit_Weight_karbaradi(n);}
if(strcmp(vorood_edit_karbar_adi,"edit  Height")==0||strcmp(vorood_edit_karbar_adi,"7")==0){edit_Height_karbaradi(n); }
if(strcmp(vorood_edit_karbar_adi,"edit  Age ")==0||strcmp(vorood_edit_karbar_adi,"8")==0){edit_Age_karbaradi(n); }
if(strcmp(vorood_edit_karbar_adi,"your bloodtype")==0||strcmp(vorood_edit_karbar_adi,"9")==0){ edit_bloodtype_karbaradi(n);}
if(strcmp(vorood_edit_karbar_adi,"edit your password")==0||strcmp(vorood_edit_karbar_adi,"10")==0){edit_password_karbaradi(n); }
...
if(strcmp(vorood_admin_section,"Enter the hospital")==0||strcmp(vorood_admin_section,"2")==0){ Enter_the_hospital(); }
if(strcmp(vorood_admin_section,"View statistics")==0||strcmp(vorood_admin_section,"3")==0){View_statistics();}
if(strcmp(vorood_admin_section,"Possibility to import improved people")==0||strcmp(vorood_admin_section,"4")==0){Possibility_to_import_improved_people(); }
if(strcmp(vorood_admin_section,"View all app users")==0||strcmp(vorood_admin_section,"5")==0){View_all_app_users(); }
if(strcmp(vorood_admin_section,"Seeing the dead ")==0||strcmp(vorood_admin_section,"6")==0){ Seeing_the_dead(); } 
if(strcmp(vorood_admin_section,"View all registered businesses ")==0||strcmp(vorood_admin_section,"7")==0){ View_all_registered_businesses();  }
if(strcmp(vorood_admin_section,"View all registered hospitals")==0||strcmp(vorood_admin_section,"8")==0){ View_all_registered_hospitals();  } 
...
if(strcmp(voroodiadmin,"Registration of user death")==0||strcmp(voroodiadmin,"1")==0){ Registration_of_user_death();}
if(strcmp(voroodiadmin,"registration of improved user")==0||strcmp(voroodiadmin,"2")==0){registration_of_improved_user();}
...
if(strcmp(vorood_sahebin_section,"View location status")==0||strcmp(vorood_sahebin_section,"1")==0){View_location_status(n); }
if(strcmp(vorood_sahebin_section,"Informing for disinfection ")==0||strcmp(vorood_sahebin_section,"2")==0){ Informing_for_disinfection(n);}
if(strcmp(vorood_sahebin_section,"editing information")==0||strcmp(vorood_sahebin_section,"3")==0){editing_information_sahebin(n); }
if(strcmp(vorood_sahebin_section,"Display the number of infected people")==0||strcmp(vorood_sahebin_section,"4")==0){Display_the_number_of_infected_people(n); }
if(strcmp(vorood_sahebin_section,"sign out")==0||strcmp(vorood_sahebin_section,"5")==0){voroodkarbar(); }
...
if(strcmp(vorood_editing_information,"1")!=0&&strcmp(vorood_editing_information,"2")!=0&&strcmp(vorood_editing_information,"3")!=0&&strcmp(vorood_editing_information,"4")!=0&&strcmp(vorood_editing_information,"5")!=0&&strcmp(vorood_editing_information,"6")!=0&&strcmp(vorood_editing_information,"7")!=0&&strcmp(vorood_editing_information,"edit  Firstname")!=0&&strcmp(vorood_editing_information,"edit  lastname")!=0&&strcmp(vorood_editing_information,"1")!=0&&strcmp(vorood_editing_information,"edit  NationalCode")!=0&&strcmp(vorood_editing_information,"edit  username")!=0&&strcmp(vorood_editing_information,"edit  email")!=0&&strcmp(vorood_editing_information,"edit  Urban area_of the place")!=0&&strcmp(vorood_editing_information,"edit  Shop location name")!=0&&strcmp(vorood_editing_information,"edit   City location")!=0&&strcmp(vorood_editing_information,"edit your password")!=0&&strcmp(vorood_editing_information,"8")!=0&&strcmp(vorood_editing_information,"edit your shop name")!=0){
	...
	Sleep(500);
	editing_sahebin_section(n);}
if(strcmp(vorood_editing_information,"edit  NationalCode")==0||strcmp(vorood_editing_information,"1")==0){edit_NationalCode_sahebin(n); }
if(strcmp(vorood_editing_information,"edit  username")==0||strcmp(vorood_editing_information,"2")==0){edit_username_sahebin(n); }
if(strcmp(vorood_editing_information,"edit  email")==0||strcmp(vorood_editing_information,"3")==0){ edit_email_sahebin(n);}
if(strcmp(vorood_editing_information,"edit   City location ")==0||strcmp(vorood_editing_information,"4")==0){City_location_sahebin(n); }
if(strcmp(vorood_editing_information," edit  Shop location name")==0||strcmp(vorood_editing_information,"5")==0){ Shop_location_name_sahebin(n);}
if(strcmp(vorood_editing_information,"edit  Urban area_of the place ")==0||strcmp(vorood_editing_information,"6")==0){Urban_area_of_the_place_sahebin(n); }
if(strcmp(vorood_editing_information,"edit your password")==0||strcmp(vorood_editing_information,"7")==0){edit_password_sahebin(n); }
if(strcmp(vorood_editing_information,"edit your shop name")==0||strcmp(vorood_editing_information,"8")==0){edit_your_shop_name(n);}
}
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
////////////////////////////////////////////////////////
